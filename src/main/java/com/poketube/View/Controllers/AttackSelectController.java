...
import com.poketube.Game.Types.NormalType;
...
public class AttackSelectController implements IController {
    ...
    private <T> void syncAttacks(ListChangeListener.Change<? extends T> c) {
        while (c.next()) {
            ...
            if (selectedAttacks.size() > ATTACK_PER_MON) {
                ...
                Platform.runLater(() -> { attackList.getSelectionModel().clearSelection(index); });
            }
    ...
    private void checkButton() {
        System.out.println("checkButton :" + teamAttacks.values());
